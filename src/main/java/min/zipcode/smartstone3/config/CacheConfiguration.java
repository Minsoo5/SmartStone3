...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, min.zipcode.smartstone3.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, min.zipcode.smartstone3.repository.UserRepository.USERS_BY_EMAIL_CACHE);
